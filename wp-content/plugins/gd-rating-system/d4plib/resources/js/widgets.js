    ...
    d4plib_widgets = {
        init: function() {
            $(document).on("click", ".d4plib-widget-tab", function(e){
                ...
                $(".d4plib-widget-active-tab", tabs).val(tab);
                $(".d4plib-widget-tab", tabs).removeClass("d4plib-tab-active");
                $(".d4plib-tabname-" + tab, tabs).addClass("d4plib-tab-active");

                $(".d4plib-tab-content", content).removeClass("d4plib-content-active");
                $(".d4plib-tabname-" + tab, content).addClass("d4plib-content-active");
            });
        ...
        settings: function() {
            ...
            $("input.d4p-setting-number").numeric();
            $("input.d4p-setting-integer").numeric({decimalPlaces: 0, negative: false});
        }
    };
